...
export default function Home() {
  ...
  return <main className="min-h-screen bg-[#faf9f5] text-[#1f3529]">
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <section className="relative mb-8 min-h-[300px] overflow-hidden rounded-[1.75rem] sm:min-h-[350px]">
        ...
        <div className="relative flex min-h-[300px] max-w-2xl flex-col justify-center px-5 py-7 text-white sm:min-h-[350px] sm:px-10 lg:px-12"><div className="max-w-xl rounded-2xl bg-[#13271d]/75 p-5 shadow-sm backdrop-blur-sm sm:p-7">
      ...
      <Tabs value={view} onValueChange={setView}>
        ...
        <TabsContent value="recipes">
          <div className="mb-5 flex items-center justify-between gap-4"><h2 className="font-serif text-lg font-medium text-[#526158] sm:text-xl">Choose what sounds good for {weekLabel}.</h2><div className="relative hidden sm:block"><Search className="absolute left-3 top-2.5" size={18}/><Input className="w-64 rounded-lg bg-white pl-10" value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search recipes"/></div></div>
