    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <Tabs value={view} onValueChange={setView}>
        <div className="sticky top-0 z-30 -mx-4 mb-4 bg-[#faf9f5] pb-1.5 sm:static sm:mx-0 sm:mb-0 sm:bg-transparent sm:pb-0">
          <div className="flex items-center gap-2 border border-x-0 border-t-0 border-[#dedbd2] bg-white p-1.5 shadow-sm sm:rounded-none sm:border-0 sm:border-b sm:bg-transparent sm:p-0 sm:shadow-none">
