    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <header className="relative mb-6 overflow-hidden rounded-[1.75rem]">
        ...
        <div className="relative flex flex-col gap-4 px-5 py-6 text-white sm:flex-row sm:items-center sm:justify-between sm:px-8 sm:py-8">
          ...
          <Button onClick={()=>setOpen(true)} aria-label="Add a recipe" className="h-11 shrink-0 self-start rounded-lg border border-white/40 bg-white/15 px-4 text-sm font-semibold text-white shadow-none backdrop-blur-sm transition-colors hover:border-white hover:bg-white hover:text-[#244832] sm:h-10 sm:self-auto"><Plus size={18}/>Add recipe</Button>
        </div>
      </header>
