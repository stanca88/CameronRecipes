        ...
        <div className="overflow-hidden rounded-[1.75rem] border border-[#dedbd2] bg-white">
          ...
          <div className="p-6 sm:p-9 lg:p-12">
            <div className="border-b border-[#e8e3da] pb-8">
              {activeRecipe.sourceUrl?<p className="mb-2 text-xs font-bold uppercase tracking-[.2em]"><a href={activeRecipe.sourceUrl} target="_blank" rel="noreferrer" className="text-[#477457] underline decoration-[#477457]/40 underline-offset-2 hover:decoration-[#477457]">{activeRecipe.sourceName||"View original recipe"}</a></p>:<p className="mb-2 text-xs font-bold uppercase tracking-[.2em] text-[#477457]">Family recipe</p>}<h2 className="max-w-3xl font-serif text-3xl font-bold leading-tight sm:text-5xl">{activeRecipe.title}</h2>
