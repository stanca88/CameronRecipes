        ...
        <div className="overflow-hidden rounded-[1.75rem] border border-[#dedbd2] bg-white">
          ...
          <div className="p-6 sm:p-9 lg:p-12">
            <div className="border-b border-[#e8e3da] pb-8">
              {(()=>{const cuisine=cuisineFor(activeRecipe);return <div className="mb-2 flex flex-wrap items-center gap-2 text-xs font-bold uppercase tracking-[.2em]">{cuisine&&<span className="rounded-full bg-[#e6efe7] px-2.5 py-1 text-[#257F4B]">{cuisine}</span>}{activeRecipe.sourceUrl?<a href={activeRecipe.sourceUrl} target="_blank" rel="noreferrer" className="text-[#477457] underline decoration-[#477457]/40 underline-offset-2 hover:decoration-[#477457]">{activeRecipe.sourceName||"View original recipe"}</a>:!cuisine&&<span className="text-[#477457]">Family recipe</span>}</div>})()}
