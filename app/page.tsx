      ...
      <Tabs value={view} onValueChange={changeView}>
        {view==="recipes"
          ...
          : <div className="mb-4 flex items-center gap-2 pb-2 pt-4 sm:pt-3">
              ...
              <TabsList className="!h-auto flex flex-1 items-stretch overflow-hidden rounded-lg border border-[#d9d5cc] bg-white shadow-none sm:flex-none sm:gap-2 sm:rounded-none sm:border-0 sm:border-b sm:bg-transparent sm:p-0 sm:shadow-none">
