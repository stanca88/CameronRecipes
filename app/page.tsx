...
const starterRecipes: Recipe[] = [
  {id:"roasted-veg-bowl",title:"Roasted Vegetable Grain Bowl",emoji:"🥗",time:"35 min",serves:4,author:"Maria",image:withBasePath("/veg-bowl.jpg"),ingredients:[
  ...
  {id:"lemon-herb-chicken",title:"Lemon Herb Chicken",emoji:"🍗",time:"40 min",serves:4,author:"Dad",image:withBasePath("/lemon-chicken.jpg"),ingredients:[
  ...
  {id:"beef-stew",title:"Hearty Beef Stew",emoji:"🥘",time:"2 hr",serves:6,author:"Dad",image:withBasePath("/beef-stew.jpg"),ingredients:[
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      {activeRecipe ? <article>
        ...
        <div className="overflow-hidden rounded-[1.75rem] border border-[#dedbd2] bg-white">
          {(activeRecipe.image || (activeRecipe.id==="roasted-veg-bowl"?withBasePath("/veg-bowl.jpg"): activeRecipe.id==="lemon-herb-chicken"?withBasePath("/lemon-chicken.jpg"): activeRecipe.id==="beef-stew"?withBasePath("/beef-stew.jpg"):"")) ? <img src={activeRecipe.image || (activeRecipe.id==="roasted-veg-bowl"?withBasePath("/veg-bowl.jpg"): activeRecipe.id==="lemon-herb-chicken"?withBasePath("/lemon-chicken.jpg"): activeRecipe.id==="beef-stew"?withBasePath("/beef-stew.jpg"):"")} alt={activeRecipe.title} className="h-64 w-full object-cover sm:h-80 lg:h-[28rem]"/> : <div className="grid h-56 place-items-center bg-[#e8f0e8] text-8xl">{activeRecipe.emoji}</div>}
      ...
      <header className="relative mb-8 min-h-[300px] overflow-hidden rounded-[1.75rem] sm:min-h-[350px]">
        <img src={withBasePath("/family-taco-night.png?v=2")} alt="Fresh ingredients prepared for family taco night" className="absolute inset-0 h-full w-full object-cover object-center"/>
