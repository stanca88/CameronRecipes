...
export default function Home() {
  ...
  return <main className="min-h-screen bg-[#faf9f5] text-[#1f3529]">
    <header className="border-b border-[#e5e1d8] bg-[#fdfcf9]/95"><div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5 sm:px-6">
      <h1 className="font-serif text-xl font-bold sm:text-2xl">The Camerons</h1>
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <Tabs value={view} onValueChange={setView}>
        <div className="mb-8 flex w-full items-end gap-1 overflow-x-auto border-b border-[#dedbd2]">
          ...
          <div className="relative ml-auto hidden shrink-0 pb-1 sm:block"><Search className="absolute left-3 top-2.5 text-[#526158]" size={17}/><Input className="h-9 w-56 rounded-lg border-[#d9d5cc] bg-white pl-9 shadow-none" value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search recipes"/></div>
        </div>
