  ...
  return <main className="min-h-screen bg-[#faf9f5] text-[#1f3529]" style={{scrollbarGutter:'stable'}}>
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <Tabs value={view} onValueChange={setView}>
        <div className="sticky top-0 z-30 -mx-4 mb-4 bg-[#faf9f5] px-4 pb-1.5 pt-2 sm:static sm:mx-0 sm:mb-0 sm:bg-transparent sm:px-0 sm:pb-0 sm:pt-0">
          <div className="flex items-center gap-2 rounded-2xl border border-[#dedbd2] bg-white p-1.5 shadow-sm sm:rounded-none sm:border-0 sm:border-b sm:bg-transparent sm:p-0 sm:shadow-none">
            <TabsList className="!h-auto grid flex-1 grid-cols-4 gap-1 rounded-xl bg-transparent p-0 shadow-none sm:flex sm:flex-none sm:items-center sm:justify-start sm:rounded-none">
